namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string FindexGetAllSuccess = "Findx puanları başarılı bir şekilde getirildi.";
        public static string FindexGetByUserIdSuccess = "Kullanıcıya ait findex puanı başarılı bir şekilde getirildi.";
        public static string FindexAddSuccess = "Findex puanı başarılı bir şekilde eklendi.";
